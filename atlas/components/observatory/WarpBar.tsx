      ...
      <form onSubmit={engage} className="hud-panel flex items-center gap-3 px-4 py-2.5">
        <span
          className={`text-[10px] font-medium tracking-[0.3em] uppercase ${
            busy ? "pulse-soft text-accent" : "text-ink-3"
          }`}
        >
          {busy ? "charging" : "warp"}
        </span>
        ...
        <button
          ...
          className="rounded-full border border-accent/60 px-3 py-1 text-[11px] tracking-widest text-accent uppercase transition-opacity disabled:opacity-30"
        >
          engage
        </button>
      </form>
