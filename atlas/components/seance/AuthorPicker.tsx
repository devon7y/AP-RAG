    ...
    <div className="absolute inset-0 z-40 flex items-center justify-center p-4">
      ...
      >
        ...
        <input
          ...
          autoFocus
          className="mt-4 w-full rounded-lg border border-hairline bg-page/60 px-3 py-2 text-sm text-ink outline-none placeholder:text-ink-3 focus:border-[color:var(--accent)]"
        />
