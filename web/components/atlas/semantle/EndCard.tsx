...
import type { Paper } from "@/lib/atlas/types";
              ...
              <span
                ...
                style={
                  won
                    ...
                    : { borderColor: "var(--atlas-baseline)", color: "var(--atlas-ink-2)" }
                }
              >
                {won
              ...
              <>
                ...
                {paper.doi && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="mt-1 inline-block text-xs text-atlas-accent transition-opacity hover:opacity-80"
                  >
                    doi:{paper.doi}
                  </a>
                )}
