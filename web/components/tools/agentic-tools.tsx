...
└── aprag package
   ...
   │   └── gpt-6-luna, Fast tier     (answer synthesis only)      │
   └──────────────────────────────────────────────────────────────┘`}</Code>
          <P>
          ...
          <Sub title="Retrieval">
            <div>
              <Row name="aprag_query" note="question, mode, reasoning">
                ...
                references list. The server retrieves, gpt-6-luna synthesizes,
        ...
        >
          ...
          <Sub title="Query (live, on the server)">
            <P>
              ...
              gpt-6-luna, which writes an answer with numeric citations; the
